...
window.addEventListener("load", () => {
    ...
    const selectRandomUser = () => Math.random() < .5 ? __tester.defaults.testUser1 : __tester.defaults.testUser2;
    const shuffle = list => {
            ...
            try {
                ...
                if (!manager) {
                    ...
                    if (!isManager) {
                        ...
                        let header = await expressFunc("testCreateSession", testUser.username, 2e3);
